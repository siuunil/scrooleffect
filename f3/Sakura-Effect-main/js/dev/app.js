...
function renderPointFlowers() {
  var PI2 = Math.PI * 2;
  [pointFlower.area.x, pointFlower.area.y, pointFlower.area.z];
...
function createEffectLib() {
  ...
  effectLib.sceneBg = createEffectProgram(cmnvtxsrc, frgsrc, ["uTimes"]);
  frgsrc = document.getElementById("fx_brightbuf_fsh").textContent;
  effectLib.mkBrightBuf = createEffectProgram(cmnvtxsrc, frgsrc, null);
  frgsrc = document.getElementById("fx_dirblur_r4_fsh").textContent;
  effectLib.dirBlur = createEffectProgram(cmnvtxsrc, frgsrc, ["uBlurDir"]);
  vtxsrc = document.getElementById("pp_final_vsh").textContent;
  frgsrc = document.getElementById("pp_final_fsh").textContent;
  effectLib.finalComp = createEffectProgram(vtxsrc, frgsrc, ["uBloom"]);
}
...
function animate() {
  ...
  timeInfo.elapsed = (curdate - timeInfo.start) / 1e3;
  timeInfo.delta = (curdate - timeInfo.prev) / 1e3;
...
window.addEventListener("load", function(e) {
  ...
  createScene();
  initScene();
  timeInfo.start = /* @__PURE__ */ new Date();
